...
<?php 
	...
	$seed = 2147483647;	//some large number that can be used as seed, the larger the better
	$fingerprint = hash_hmac("sha256", mt_rand(1,$seed), mt_rand(1,$seed)); //pseudorandom value that can be used as fingerprint
	$cookie_name = "fpt";
	$novelty = time() + (86400 * 30);	//assuming the user as "fresh" if not using the platform for 'novelty' duration(30 days)
